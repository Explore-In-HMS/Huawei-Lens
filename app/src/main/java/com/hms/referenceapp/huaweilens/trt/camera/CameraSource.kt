...
class CameraSource(var activity: Activity, private val graphicOverlay: GraphicOverlay) {
            ...
            while (true) {
                ...
                try {
                    synchronized(processorLock) {
                        ...
                        if(TrtFragmentPresenter.SendLangCode.getisOpenedSpinner()!=true){
    ...
    companion object {
        ...
        const val isAutoFocus:Boolean=false
