...
public class CropImageView extends FrameLayout {
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    if (options == null) {
      ...
      if (attrs != null) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.hms.referenceapp.huaweilens.R.styleable.CropImageView, 0, 0);
        try {
          options.fixAspectRatio =
              ta.getBoolean(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropFixAspectRatio, options.fixAspectRatio);
          options.aspectRatioX =
              ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropAspectRatioX, options.aspectRatioX);
          options.aspectRatioY =
              ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropAspectRatioY, options.aspectRatioY);
          options.scaleType =
              ScaleType.values()[
                  ta.getInt(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropScaleType, options.scaleType.ordinal())];
          options.autoZoomEnabled =
              ta.getBoolean(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropAutoZoomEnabled, options.autoZoomEnabled);
          options.multiTouchEnabled =
              ta.getBoolean(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMultiTouchEnabled, options.multiTouchEnabled);
          options.maxZoom = ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMaxZoom, options.maxZoom);
          options.cropShape =
              CropShape.values()[
                  ta.getInt(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropShape, options.cropShape.ordinal())];
          options.guidelines =
              Guidelines.values()[
                  ta.getInt(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropGuidelines, options.guidelines.ordinal())];
          options.snapRadius =
              ta.getDimension(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropSnapRadius, options.snapRadius);
          options.touchRadius =
              ta.getDimension(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropTouchRadius, options.touchRadius);
          options.initialCropWindowPaddingRatio =
              ta.getFloat(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropInitialCropWindowPaddingRatio,
                  options.initialCropWindowPaddingRatio);
          options.borderLineThickness =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderLineThickness, options.borderLineThickness);
          options.borderLineColor =
              ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderLineColor, options.borderLineColor);
          options.borderCornerThickness =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderCornerThickness,
                  options.borderCornerThickness);
          options.borderCornerOffset =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderCornerOffset, options.borderCornerOffset);
          options.borderCornerLength =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderCornerLength, options.borderCornerLength);
          options.borderCornerColor =
              ta.getInteger(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderCornerColor, options.borderCornerColor);
          options.guidelinesThickness =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropGuidelinesThickness, options.guidelinesThickness);
          options.guidelinesColor =
              ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropGuidelinesColor, options.guidelinesColor);
          options.backgroundColor =
              ta.getInteger(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBackgroundColor, options.backgroundColor);
          options.showCropOverlay =
              ta.getBoolean(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropShowCropOverlay, mShowCropOverlay);
          options.showProgressBar =
              ta.getBoolean(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropShowProgressBar, mShowProgressBar);
          options.borderCornerThickness =
              ta.getDimension(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropBorderCornerThickness,
                  options.borderCornerThickness);
          options.minCropWindowWidth =
              (int)
                  ta.getDimension(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMinCropWindowWidth, options.minCropWindowWidth);
          options.minCropWindowHeight =
              (int)
                  ta.getDimension(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMinCropWindowHeight,
                      options.minCropWindowHeight);
          options.minCropResultWidth =
              (int)
                  ta.getFloat(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMinCropResultWidthPX,
                      options.minCropResultWidth);
          options.minCropResultHeight =
              (int)
                  ta.getFloat(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMinCropResultHeightPX,
                      options.minCropResultHeight);
          options.maxCropResultWidth =
              (int)
                  ta.getFloat(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMaxCropResultWidthPX,
                      options.maxCropResultWidth);
          options.maxCropResultHeight =
              (int)
                  ta.getFloat(
                          com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropMaxCropResultHeightPX,
                      options.maxCropResultHeight);
          options.flipHorizontally =
              ta.getBoolean(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropFlipHorizontally, options.flipHorizontally);
          options.flipVertically =
              ta.getBoolean(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropFlipHorizontally, options.flipVertically);

          mSaveBitmapToInstanceState =
              ta.getBoolean(
                      com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropSaveBitmapToInstanceState,
                  mSaveBitmapToInstanceState);

          // if aspect ratio is set then set fixed to true
          if (ta.hasValue(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropAspectRatioX)
              && !ta.hasValue(com.hms.referenceapp.huaweilens.R.styleable.CropImageView_cropFixAspectRatio)) {
    ...
    View v = inflater.inflate(com.hms.referenceapp.huaweilens.R.layout.crop_image_view, this, true);

    mImageView = v.findViewById(com.hms.referenceapp.huaweilens.R.id.ImageView_image);
    mImageView.setScaleType(ImageView.ScaleType.MATRIX);

    mCropOverlayView = v.findViewById(com.hms.referenceapp.huaweilens.R.id.CropOverlayView);
    ...
    mProgressBar = v.findViewById(com.hms.referenceapp.huaweilens.R.id.CropProgressBar);
