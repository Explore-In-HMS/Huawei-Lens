package com.hms.referenceapp.huaweilens.trt.views;
...
public abstract class WheelPicker extends View {
    ...
    protected WheelPicker(Context context) {
        this(context, null);
    }

    protected WheelPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        adapter = new Adapter();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + selectedItemPosition,
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                canvas.drawText(data, drawnCenterX, mDrawnItemCenterY, paint);
                canvas.restore();

                paint.setColor(mSelectedItemTextColor);
                paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
                paint.setTextSize(mItemTextSize + 10f);
