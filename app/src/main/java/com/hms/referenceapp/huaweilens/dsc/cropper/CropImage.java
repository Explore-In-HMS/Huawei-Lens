...
public final class CropImage {
  ...
  public static Intent getPickImageChooserIntent(@NonNull Context context) {
    return getPickImageChooserIntent(
        context, context.getString(com.hms.referenceapp.huaweilens.R.string.pick_image_intent_chooser_title), false, true);
  }
  ...
  public static final class ActivityBuilder {
    ...
    /** Get {@linkcom.hms.referenceapp.huaweilens.dsc.cropper.CropImageActivity} intent to start the activity. */
